...
public class GetByIdProductQueryHandler(IMapper mapper, IUnitOfWork unitOfWork) : BaseHandler(mapper, unitOfWork),
    IRequestHandler<GetByIdProductQueryRequest, ResponseDto<GetByIdProductQueryResponse>>
{
